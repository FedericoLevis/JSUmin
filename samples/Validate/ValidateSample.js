...
function sampleOpt(event,iSample){
  var fn="[ValidateSample.js sampleOpt] ";
	...
	'       <li>You can <b>Change Options</b>, click button <b>Apply</b> and test again the SAMPLE with the new Options</li>' +
	'     </ul>' +
	'   </td>' +
	'</tr>' +
	'</table>' +
	...
	' </tr>' +
	'<tr><td align="center">' + 
	'      <div align="center" style="width:100%;margin-top:20px;margin-bottom:2px;"><input type="button" class="jsuButton" value="Apply" onclick="applyValidateOption(' + iSample + ',false);"/>' +
  '      <input type="button" class="jsuButton" style="margin-left:30px;" value="Apply & Close" onclick="applyValidateOption(' + iSample + ',true);"/></div>' +
	'</td></tr></table><BR/>';
 ...
 */
function applyValidateOption(iSample,bClose){
