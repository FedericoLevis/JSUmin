...
return t(e),{a:a.join("").replace(/\n$/,""),c:i}}function n(e,t,n,r){t&&(e={a:t,d:e},n(e),r.push.apply(r,e.e))}function r(t,r){function a(e){for(var t=e.d,c=[t,"pln"],u=0,d=e.a.match(s)||[],p={},g=0,h=d.length;g<h;++g){var f,m=d[g],y=p[m],v=void 0
if("string"==typeof y)f=!1
else{var w=i[m.charAt(0)]
if(w)v=m.match(w[1]),y=w[0]
else{for(f=0;f<l;++f)if(w=r[f],v=m.match(w[1])){y=w[0]
...
!function(){for(var n=t.concat(r),a=[],o={},l=0,c=n.length;l<c;++l){var u=n[l],d=u[3]
...
for(var p=Math.max(0,t-1|0)||0,u=0,g=c.length;u<g;++u)a=c[u],a.className="L"+(u+p)%10,a.firstChild||a.appendChild(o.createTextNode(" ")),d.appendChild(a)
...
break}g||((g=!!(g=a.className.match(/\blinenums\b(?::(\d+))?/))&&(!g[1]||!g[1].length||+g[1]))&&s(a,g),u={g:i,h:a,i:g},l(u))}}d<r.length?setTimeout(t,250):e&&e()}for(var n=[document.getElementsByTagName("pre"),document.getElementsByTagName("code"),document.getElementsByTagName("xmp")],r=[],a=0;a<n.length;++a)for(var i=0,o=n[a].length;i<o;++i)r.push(n[a][i])
var n=q,c=Date
