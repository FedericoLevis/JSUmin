...
return null==e?(n&&alert("SW ERROR [jsu_getElementById2] NOT FOUND Id="+t),0):e}function jsu_elementShow(t,n,e){0!=t&&void 0!=t&&(void 0==e&&(e="block"),n?(t.style.visibility="visible",t.style.display=e):(t.style.visibility="hidden",t.style.display="none"))}function jsu_err(t){"undefined"!=typeof Popup?Popup(POPUP_TYPE.ERR,t):alert(t)}var JSU_VERSION="JSU v. 1.8 &nbsp;&nbsp;&nbsp;Last Update: 2016-Sep-18",JSU_LOG_FUN_START="------------------------ START",JSU_LOG_FUN_END="------------------------ END"
