...
if(this.iTblFooterRec=0,void 0!=this.tblSort&&void 0!=this.tblSort.rows){for(var s=this.iRowSortHeader;s<this.tblSort.rows.length;s++){var i=this.tblSort.rows[s].firstChild.type,l=!1,a=this.tblSort.rows[s].firstChild.outerHTML
void 0!=a&&a.indexOf('type="'+this.szClassFooter+'"')>=0&&(l=!0)
var n=this.tblSort.rows[s].className
this.bCognos&&(n=i)
var _=l||void 0!=n&&n.indexOf(this.szClassFooter)>=0
"columnTitle"==i||_||S++,_&&(jslog(JSLOG_JSU,"Rec ["+s+"]  IS FOOTER"),this.bCognos&&(this.tblSort.rows[s].className=this.szClassFooter),this.iTblFooterRec++)}jslog(JSLOG_JSU,e+"TABLE iTblRecNum="+S+" - iRowHeader="+this.iRowHeader+" iRowSortHeader="+this.iRowSortHeader+"  iTblFooterRec="+this.iTblFooterRec+"  (rows="+this.tblSort.rows.length+")"),this.bCognos&&(this.bMultiPage=0!=this.iTblRowPerPage&&S>=this.iTblRowPerPage||isMultiPage()),jslog(JSLOG_JSU,e+"this.bMultiPage="+this.bMultiPage)}this.iTblRecNum=S
var h=""
if(this.bMultiPage?(this.szSortPathNone=this.szPathImg+(this.bCognosGlobalSort?SORT_IMG_NONE_SLOW:SORT_IMG_NONE_DIS),this.szSortPathAsc=this.szPathImg+(this.bCognosGlobalSort?SORT_IMG_ASC_SLOW:SORT_IMG_ASC_DIS),this.szSortPathDesc=this.szPathImg+(this.bCognosGlobalSort?SORT_IMG_DESC_SLOW:SORT_IMG_DESC_DIS),h=SORT_HINT_REC_NUM_PART.replace("XXX",S),this.bCognosGlobalSort?(this.szSortHintAsc=SORT_HINT_GLOBAL_ASC+"\n\n"+h,this.szSortHintDesc=SORT_HINT_GLOBAL_DESC+"\n\n"+h):(this.szSortHintAsc=SORT_HINT_DISABLED+"\n\n"+h,this.szSortHintDesc=this.szSortHintAsc)):(this.szSortPathNone=this.szPathImg+SORT_IMG_NONE_FAST,this.szSortPathAsc=this.szPathImg+SORT_IMG_ASC_FAST,this.szSortPathDesc=this.szPathImg+SORT_IMG_DESC_FAST,h=SORT_HINT_REC_NUM_ALL.replace("XXX",S),this.szSortHintAsc=SORT_HINT_ASC+"\n\n"+h,this.szSortHintDesc=SORT_HINT_DESC+"\n\n"+h),this.szSortPathWait=this.szPathImg+SORT_IMG_WAIT,jslog(JSLOG_JSU,e+"this.szSortPathNone="+this.szSortPathNone+" this.szSortPathAsc="+this.szSortPathAsc+" this.szSortPathDesc="+this.szSortPathDesc),this.bCognos){jslog(JSLOG_JSU,e+"Get select of SORT BOX Otions (e.g for Cognos)")
var T=getFW()
this.selectSortCol=T._oLstChoices_SelectSortCol,this.selectSortCol._cSortTableEl=this,this.selectSortCol.onchange=this.onchangeSortCol,this.selectSortDir=T._oLstChoices_SelectSortDir,this.selectSortDir._cSortTableEl=this,this.selectSortDir.onchange=this.onchangeSortDir,selectRemoveExtraItems(this.selectSortDir),this.inputSortCol=T._textEditBox_SortCol,this.inputSortDir=T._textEditBox_SortDir,this.inputSortHiddenCol=T._textEditBox_SortHiddenCol}jslog(JSLOG_JSU,e+"populate this.arcSortItem"),this.arcSortItem=new Array
var O=0
this.selectSortCol&&selectRemoveAll(this.selectSortCol)
for(var c=0;c<o.length;c++)void 0==o[c].col&&(o[c].col=c+1),void 0==o[c].type&&(o[c].type=SORT_TYPE.STRING),this.selectSortCol&&appendOptionLast(this.selectSortCol,o[c].col,o[c].col),O++
if(this.arSortCol=o,this.inputSortHiddenCol){var g=this.inputSortHiddenCol.value
if(jslog(JSLOG_JSU,"szSortHidden = "+g),g.length){var C=g.split(",")
this.sorttableSetHiddenCol(C)}}if(this.selectSortCol&&(jslog(JSLOG_JSU,"Align Current Sort Selection to Visible Fields"),selectSelValue(this.selectSortCol,this.inputSortCol.value),selectSelValue(this.selectSortDir,this.inputSortDir.value),jslog(JSLOG_JSU,"Init Global Val form Cognos Hidden Fields"),this.iSortColInd=this.selectSortCol.selectedIndex,this.szSortDir=this.inputSortDir.value,this.szSortCol=this.inputSortCol.value),this.tblSort&&this.sortInit(),void 0!=r&&(r.szSortCol||r.szSortDir)){var d=void 0!=r.bSortApply&&r.bSortApply
jslog(JSLOG_JSU,e+"Obtional Initial Sort is SET: SortCol="+r.szSortCol+" szSortDir="+r.szSortDir+" bSortApply="+d),this.setSort(r.szSortCol,r.szSortDir,d)}this.bMultiPage&&!this.bCognosGlobalSort&&this.sorttableDisableSort(),jslog(JSLOG_JSU,e+JSLOG_FILE_END)}},cSortTable.prototype.setSort=function(t,o,r){var e="[cSortTable.setSort] "
...
if(S<0)return}jslog(JSLOG_JSU,e+"iSortColInd="+S)
...
a!=this.iSortColInd&&0!=this.imgSortCur&&(jslog(JSLOG_JSU,"Changed Sort column from "+this.iSortColInd+" to "+a+"   --\x3e Reset Previous Img"),this.imgSortCur.setAttribute(SORT_ATTR_SORT_DIR,SORT_DIR.NONE),this.imgSortCur.setAttribute("title",this.szSortHintDesc),this.imgSortCur.setAttribute("src",this.szSortPathNone)),this.iSortColInd=a,this.szSortCol=this.arSortCol[this.iSortColInd].col,jslog(JSLOG_JSU,"SET iSortColInd = "+this.iSortColInd+"  szSortCol="+this.szSortCol),this.imgSortCur=s,s.setAttribute(SORT_ATTR_SORT_DIR,o),this.szSortDir=o,o==SORT_DIR.ASC?(s.setAttribute("title",this.szSortHintAsc),s.setAttribute("src",this.szSortPathAsc)):(s.setAttribute("title",this.szSortHintDesc),s.setAttribute("src",this.szSortPathDesc))}jslog(JSLOG_JSU,e+JSLOG_FUN_END)},cSortTable.prototype.sorttableSetHiddenCol=function(t){var o="[cSortTable.sorttableSetHiddenCol] "
jslog(JSLOG_JSU,o+JSLOG_FUN_START),arTrace(JSLOG_JSU,t,o+"ArColId")
var r=this.selectSortCol.selectedIndex
if(jslog(JSLOG_JSU,o+"this.selectSortCol iSelInd="+r),r<0)return void jslog(JSLOG_JSU,o+"return (iSelInd <0)")
...
jslog(JSLOG_JSU,t+"numColHidden="+e)}var l=this.arSortCol.length,a=r<l?r:l-e
jslog(JSLOG_JSU,t+"iColVis="+r+"  iSortColNum="+l+"  ---\x3e iColSort="+a),jslog(JSLOG_JSU,t+" Prepare icons (arSortImg), events and set Current Sort")
for(var n=0;n<a;n++){var _=o.cells[n],h=this.tempTextSep.cloneNode(!1),T=this.imgTemp.cloneNode(!1)
...
return aNum-bNum},cSortTable.prototype.ts_sort_datetime=function(t,o){var r=cSortTableElCur.iSortColInd,e=t.cells[r],S=o.cells[r]
...
return l==a?0:l<a?-1:1},cSortTable.prototype.ts_sort_currency=function(t,o){var r=cSortTableElCur.iSortColInd,e=t.cells[r],S=o.cells[r]
return void 0==S||void 0==e?this.szSortDir==SORT_DIR.ASC?1:-1:(aa=ts_getInnerText(e).replace(/[^0-9.]/g,""),bb=ts_getInnerText(S).replace(/[^0-9.]/g,""),parseFloat(aa)-parseFloat(bb))},cSortTable.prototype.ts_sort_caseinsensitive=function(t,o){var r=cSortTableElCur.iSortColInd,e=t.cells[r],S=o.cells[r]
if(void 0==S||void 0==e)return jslog(JSLOG_JSU,"[cSortTable.ts_sort_caseinsensitive]  FOOTER ROW"),this.szSortDir==SORT_DIR.ASC?1:-1
aa=ts_getInnerText(e).toLowerCase(),bb=ts_getInnerText(S).toLowerCase()
return aa==bb?0:aa<bb?-1:1},cSortTable.prototype.getSortId=function(t){for(var o=-1,r=0;r<this.arSortCol.length;r++){var e=this.arSortCol[r].col
if(-1==this.szSortHiddenId.indexOf(e+",")&&o++,o==t)return e}return showErr("[cSortTable.sorttable.getSortId] SW ERROR: this.iSortColInd="+this.iSortColInd+" NOT Visible  iColInd="+t,1)},cSortTable.prototype.getSortObj=function(t){for(var o=this.getSortId(t),r=0;r<this.arSortCol.length;r++){var e=this.arSortCol[r]
if(e.col==o)return e}return showErr("[cSortTable.getSortObj] SW ERROR: this.iSortColInd="+this.iSortColInd+" NOT Found SortId="+o,1)},cSortTable.prototype.getSortIndFromSortCol=function(t){for(var o=0;o<this.arSortCol.length;o++){if(this.arSortCol[o].col==t)return o}return showErr("[cSortTable.sorttable.getSortIndFromSortCol] SW ERROR: szSortCol="+t+" NOT FOUND",1)},cSortTable.prototype.resortTable=function(t){var o="[cSortTable.resortTable] "
jslog(JSLOG_JSU,o+JSLOG_FUN_START)
var r=t.parentNode,e=r.cellIndex
jslog(JSLOG_JSU,"Clicked on column="+e+"  Previous SortCol="+this.iSortColInd),e!=this.iSortColInd&&0!=this.imgSortCur&&void 0!=this.imgSortCur&&(jslog(JSLOG_JSU,"Changed Sort column from "+this.iSortColInd+" to "+e+"   --\x3e Reset Previous Img"),this.imgSortCur.setAttribute(SORT_ATTR_SORT_DIR,SORT_DIR.NONE),this.imgSortCur.setAttribute("title",this.szSortHintDesc),this.imgSortCur.setAttribute("src",this.szSortPathNone)),this.iSortColInd=e,this.szSortCol=this.arSortCol[this.iSortColInd].col,jslog(JSLOG_JSU,"SET iSortColInd = "+this.iSortColInd+"  szSortCol="+this.szSortCol),this.imgSortCur=t
...
if(jslog(JSLOG_JSU,o+"this="+this+"  tagName="+S),void 0!==S&&"IMG"==S.toUpperCase())r=this
...
return void 0===e?showErr(t+"SW ERROR: cSortTableEl is undefined in "+t,1):jslog(JSLOG_JSU,t+"cSortTableEl.szSortPathAsc="+e.szSortPathAsc),jslog(JSLOG_JSU,t+JSLOG_FUN_END),e},cSortTable.getElement=function(t){for(var o=cSortTable.is_ie?window.event.srcElement:t.currentTarget;1!=o.nodeType||/^div$/i.test(o.tagName);)o=o.parentNode
